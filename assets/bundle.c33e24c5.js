!function(a) {
    ...
    function i(e) {
        ...
        return a[e].call(n.exports, n, n.exports, i),
        n.l = !0,
        n.exports
    }
    i.m = a,
    ...
    i.t = function(a, o) {
        ...
        8 & o)
            return a;
        if (4 & o && "object" == typeof a && a && a.__esModule)
            return a;
...
, function(a, o, i) {
    ...
    function r(a, o, i) {
        ...
        const t = e.prototype;
        return t && (n.prototype = t),
        a[o] = n,
        !0
    }
    function u(a, o, i, t) {
        const s = e(a, o);
        return !!s && (i && r(s, "get", i),
        t && r(s, "set", t),
        n(a, o, s),
        !0)
    }
        ...
        return {
            attr: function(a, i, ...e) {
                ...
                r(i, "setAttributeNode", a=>(function(o) {
                    return console.warn("setAttributeNode:", o, this),
                    t(a, this, arguments)
                }
                )))
            },
...
, function(a, o, i) {
    ...
    function p(a, o, i) {
        ...
        for (let a = 0; a < r.length; a++) {
            ...
            const t = r[a].trim()
              , s = t.indexOf("=");
            if (-1 !== s ? (o = t.substr(0, s),
            n = t.substr(s + 1)) : (o = 0 === a ? "" : t,
            n = 0 === a ? t : ""),
            0 !== a)
        ...
        if (s(e, i) && (e.isExpired = !0),
        e.name.startsWith("__Secure-") && ("https:" !== o.protocol || !e.secure))
            return;
        if (e.name.startsWith("__Host-") && ("https:" !== o.protocol || !e.secure || "" !== e.domain || "/" !== e.path))
            return;
        if (e.secure && "http:" === o.protocol)
            return;
        const u = o.hostname;
        if (e.domain) {
            if (m = e.domain,
            (c = u) !== m && !c.endsWith("." + m))
                return void console.warn("[jsproxy] invalid cookie domain! `%s` ⊄ `%s`", e.domain, u)
        } else
            e.domain = u,
            e.hostOnly = !0;
        var m, c;
        ...
        if (e.path) {
            if (!t(e.path, p))
                return void console.warn("[jsproxy] invalid cookie path! `%s` ⊄ `%s`", e.path, p)
        } else
            e.path = p;
        return e.id = (e.secure ? ";" : "") + e.name + ";" + e.domain + e.path,
        e
    }
    function l(a) {
        const o = a.id
    ...
    async function h(a) {
        g = a;
        const o = Date.now();
        await g.enum("cookie", a=>(s(a, o) ? g.delete("cookie", a.id) : l(a),
        !0)),
        setInterval(d, 3e3)
    }
    async function d() {
        ...
        e = new Set;
        for (const o of a)
            o.isExpired ? await g.delete("cookie", o.id) : isNaN(o.expires) || await g.put("cookie", o)
    }
}
, function(a, o, i) {
    "use strict";
    ...
    function r(a, o) {
        let i = 0;
        for (const {weight: e, host: n} of s[o])
            if ((i += e) > a)
                return n
    }
    function u(a, o) {
    ...
    function c(a, o) {
        ...
        return o.url__ = i + "://" + s,
        o.ver__ = t.ver,
        u(r(n.h(a.href), t.node_default), "ws") + "?" + new URLSearchParams(o)
    }
    function p(a) {
        t = a,
        s = {};
        for (const [o,i] of Object.entries(a.node_map)) {
            ...
            for (const o of a)
                o.weight = o.weight / e * 4294967295 >>> 0;
            a.sort((a,o)=>o.weight - a.weight),
            s[o] = a
        }
    }
}
...
, function(a, o, i) {
    ...
    function n(a) {
        let o = !1;
        return a = (a = a.replace(/(\b)location(\b)/g, (a,i,e)=>(o = !0,
        i + "__location" + e))).replace(/postMessage\s*\(/g, a=>(o = !0,
        a + "...(self.__set_srcWin?__set_srcWin():[]), ")),
        o ? a : null
    }
    function t(a, o) {
        const i = e.a(a, o)
...
, function(a, o, i) {
    ...
    function m(a, o) {
        r(a, "__location", {
            get: ()=>o,
            set(i) {
                console.log("[jsproxy] %s set location: %s", a, i),
                o.href = i
            }
        })
    }
    ...
    function h(a, o, i) {
        ...
        const c = new Proxy(e,{
            ...
            set(a, i, e) {
                if (!(i in t))
                    return console.log("[jsproxy] %s set: %s = %s", o, i, e),
                    r(i, e),
                    !0;
                t[i] = e
            },
            deleteProperty: (a,i)=>(console.log("[jsproxy] %s del: %s", o, i),
            u(i),
            !0),
            has: (a,e)=>(console.log("[jsproxy] %s has: %s", o, e),
            "string" == typeof e && i + e in a),
            ownKeys: a=>m(),
    ...
    function b(a, o) {
        !function(a, o) {
            ...
            h(a, "localStorage", i),
            h(a, "sessionStorage", i);
            const u = a.StorageEvent.prototype;
            function m(a) {
                return function(o) {
                    return arguments.length > 0 && (arguments[0] = i + o),
                    c(a, this, arguments)
                }
            }
            s.d(u, "key", r),
            s.d(u, "url", a=>(function() {
                const o = a.call(this);
                return e.c(o)
            }
            ));
            ...
            s.c(p, "open", m),
            s.c(p, "databases", a=>(async function() {
                const o = await c(a, this, arguments)
                  , i = [];
                for (const a of o)
                    "." !== a.name[0] && (a.name = t(a.name),
                    i.push(a));
                return i
            }
            )),
        ...
        !function(a) {
            ...
            const t = {
                ...
                set href(a) {
                    console.log("[jsproxy] set location.href:", a),
                    o.href = e.i(a, this)
                },
                set protocol(a) {
                ...
                reload() {
                    return console.warn("[jsproxy] location.reload"),
                    o.reload(...arguments)
                },
                replace(a) {
                    return a && (console.warn("[jsproxy] location.replace:", a),
                    arguments[0] = e.i(a, this)),
                    o.replace(...arguments)
                },
                assign(a) {
                    return a && (console.warn("[jsproxy] location.assign:", a),
                    arguments[0] = e.i(a, this)),
                    o.assign(...arguments)
                }
            }
        ...
        function p(o) {
            s.c(a, o, a=>(function(i) {
                return i && (console.log("[jsproxy] new %s: %s", o, i),
                arguments[0] = e.i(i, this)),
                j(a, arguments)
            }
            ))
        }
        s.c(r, "open", a=>(function(o, i) {
            return i && (arguments[1] = e.i(i, this)),
            d(a, this, arguments)
        }
        )),
        ...
        p("Worker"),
        p("SharedWorker"),
        s.c(a, "importScripts", a=>(function(...o) {
            const i = o.map(e.i);
            return console.log("[jsproxy] importScripts:", i),
            d(a, this, i)
        }
        ))
    }
    ...
    "onclick"in (e = self) ? function(a) {
        ...
        a === top) {
            ...
            a.__init__ = function(a) {
                e.init(a),
                console.log("[jsproxy] child page inited.", a.location.href)
            }
            ,
...
, function(a, o, i) {
    ...
    function k(a, o) {
        ...
        function r(a) {
            ...
            for (let a = 0, o = i.length; a < o; a++)
                r(i[a]);
            o.delNode(a),
            a === n && (e.insertBefore(n, e.firstChild),
    ...
    function g(a) {
        ...
        !function() {
            ...
            ,
            w(e.e, i),
            w(e.d)) : console.warn("[jsproxy] missing page id")
        }(),
                ...
                if (r && n) {
                    ...
                    if (a) {
                        ...
                        if (e.origin !== a.origin)
                            throw Error(`Failed to execute '${o}' on 'History': A history state object with URL '${n}' cannot be created in a document with origin '${e.origin}' and URL '${i}'.`);
                        arguments[2] = s.g(a)
                    }
                }
        ...
        z && (r.c(z, "register", a=>(function() {
            return console.warn("access serviceWorker.register blocked"),
            new Promise(function() {}
            )
        }
        )),
        r.c(z, "getRegistration", a=>(function() {
            return console.warn("access serviceWorker.getRegistration blocked"),
            new Promise(function() {}
            )
        }
        )),
        r.c(z, "getRegistrations", a=>(function() {
            return console.warn("access serviceWorker.getRegistrations blocked"),
            new Promise(function() {}
            )
        }
        ))),
        x("pushState"),
        x("replaceState"),
        r.c(a, "open", a=>(function(o) {
            return o && (arguments[0] = s.i(o, o)),
            l(a, this, arguments)
        }
        ));
        const _ = a.frames;
        ...
        r.c(d, "registerProtocolHandler", a=>(function(o, i, e) {
            return console.log("registerProtocolHandler:", arguments),
            l(a, this, arguments)
        }
        ));
        ...
        r.d(q, "domain", a=>(function() {
            ...
            console.log("[jsproxy] set document.domain:", o),
            E = o,
            a.call(this, h.hostname)
        }
        )),
        ...
        b.attr("META", O, {
            ...
            onset(a) {
                ...
                case "refresh":
                    (o = s.l(this.content, this)) !== a && (console.warn("[jsproxy] meta redir"),
                    this.content = o);
                    break;
        ...
        "http:" === j.protocol && (M("SCRIPT", A, "src"),
        M("LINK", N, "href")),
        M("EMBED", a.HTMLEmbedElement.prototype, "src"),
        M("OBJECT", a.HTMLObjectElement.prototype, "data");
        const $ = a.HTMLIFrameElement.prototype;
        M("IFRAME", $, "src"),
        M("FRAME", a.HTMLFrameElement.prototype, "src");
        ...
        r.d($, "contentDocument", a=>(function() {
            const o = a.call(this);
            return o && g(o.defaultView),
            o
        }
        )),
        D(P),
        D(T),
        r.c(W, "submit", a=>(function() {
        ...
        function F(a, o) {
            const i = a.type;
            return i && !t.e(i) ? null : B.has(a) ? null : (B.add(a),
            m.b(o))
        }
        function J(a) {
            const i = new WeakSet;
                    ...
                    1 == e.nodeType)) {
                        if (e[a]) {
                            ...
                            if (o) {
                                const i = m.b(o);
                                i && (e[a] = i,
                                console.log("[jsproxy] jsfilter onevent:", a))
                            }
                        }
                        o(e.parentNode)
                    }
...
, function(a, o, i) {
    ...
    async function g(a) {
        ...
        if (c >= i)
            return;
        c = i,
        console.log("[jsproxy] cdn cache ver:", i);
        ...
        try {
            return await async function(a, o) {
                ...
                const n = await e.arrayBuffer()
                  ...
                  , p = JSON.parse(c)
                  , l = t.subarray(2 + r);
                return p.date = (new Date).toUTCString(),
                new Response(l,{
                    headers: p
                })
            }(a, o)
    ...
    function R(a, o, i) {
        ...
        const s = a.referrer;
        return s && (n.referer = s === y ? i.origin + "/" : t.c(s)),
        n.cookie = function(a, o, i) {
            const e = i.credentials;
            if ("omit" === e)
                return "";
            if ("same-origin" === e && u.a(a.hostname) !== u.a(o.hostname))
                return "";
            return r.c(a)
        }(o, i, a),
        {
    ...
    async function M(a, o, i) {
        ...
        for (let a = 0; a < O; a++) {
            ...
            if (!s)
                break;
            console.warn("[jsproxy] cfworker fail:", s),
            k = "",
            z = 0
        }
        if (!y)
        ...
        const {status: _, headers: S, cookieStrArr: M} = function(a) {
            ...
            return o.forEach((a,o)=>{
                if ("access-control-allow-origin" === o || "access-control-expose-headers" === o)
                    return;
                if ("--s" === o)
                    return void (i = +a);
                if ("--t" === o)
                    return;
                const t = o.match(/^\d+-(.+)/);
                t ? "set-cookie" === (o = t[1]) ? e.push(a) : n.append(o, a) : (o.startsWith("--") && (o = o.substr(2)),
                "set-cookie" !== o ? n.set(o, a) : e.push(a))
            }
            ),
            {
                status: i,
        ...
        if (P) {
            const a = t.l(P, c);
            a !== P && (console.log("[jsproxy] http refresh:", P),
            S.set("refresh", a))
        }
        let T;
        if (M.length) {
    ...
    function K(a, o) {
        const i = V.get(a);
        if (!i)
            return void console.warn("[jsproxy] unknown page id:", a);
        const [e,n] = i;
        o ? (V.delete(a),
        e.notify(!0)) : clearTimeout(n)
    }
    function X(a, o=200) {
    ...
    async function Q(a, o, i) {
        ...
        for (const n of e)
            "top-level" === n.frameType && (i && n.id === i || J(n, a, o))
    }
    const Z = new Map;
    ...
    async function oa(a, o) {
        ...
        try {
            ...
            X("前端脚本错误<br><pre>" + a.stack + "</pre>", 500)
        }
    }
    let ia, ea;
    async function na() {
    ...
    function ta(a, o) {
        if (!o && I) {
            if (a.ver <= I.ver)
                return;
            a.node_map[I.node_default] ? a.node_default = I.node_default : console.warn("default node %s -> %s", I.node_default, a.node_default),
            Q(P.i, I)
        }
        !function(a) {
            W = a
    ...
    C.addEventListener("fetch", a=>{
        a.respondWith(async function(a) {
            ...
            if (i === e.g || i === e.d) {
                ...
                return I.index_path || (a = I.assets_cdn + "index_v3.html"),
                X((await fetch(a)).body)
            }
            if (i === e.b || i === e.e)
                return fetch(i);
            if (i === e.c)
    ...
    C.addEventListener("install", a=>{
        console.log("oninstall:", a),
        a.waitUntil(C.skipWaiting())
    }
    ),
